...
my $subjobs_script = "$pssh_dir/scripts/batch_run_generate_pssh2.sh";
my $arrayjob_file = "$pssh_dir/work/arrayjob.sh";

my $log_dir = "$pssh_dir/work/pssh2_log_sprot_md5sums_redo";
#remove_tree($log_dir);
mkdir $log_dir;
...
my $md5sums_uniq = "$pssh_dir/work/sprot_md5sums_redo";
