...
/mnt/project/pssh/hhsuite-2.0.13/scripts/pdb2fasta.non_redundant_chains_AS.pl \'$pdb_links_dir*.ent\' $fasta_dir$pdb_chains
...
/mnt/project/pssh/hhsuite-2.0.13/scripts/multithread.pl \'$a3m_dir*.a3m\' \'/mnt/project/pssh/hhsuite-2.0.13/scripts/addss.pl $file $psipred_a3m_dir$base".a3m"  1>$addss_log_dir$base".out" 2>$addss_log_dir$base".err"\' -cpu 10
...
rm -r $db 2>/dev/null #delete old db files (not necesserely?)
mkdir $db 2>/dev/null

hhblitsdb_log_dir="/mnt/project/pssh/pdb_full/log/hhblitsdb/"
mkdir $hhblitsdb_log_dir 2>/dev/null
/mnt/project/pssh/hhsuite-2.0.13/scripts/hhblitsdb.pl -o \'$db"pdb_full"\' -ia3m \'$psipred_a3m_dir\' -cpu 10 -log $hhblitsdb_log_dir"hhblitsdb.log"   
