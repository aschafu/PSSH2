...
our $execdir = "/mnt/home/kalemanovm/psipred/bin";  # Where the PSIPRED V2 programs have been installed
our $datadir = "/mnt/home/kalemanovm/psipred/data"; # Where the PSIPRED V2 data files have been installed
our $ncbidir = "/usr/bin/";    # Where the NCBI programs have been installed (for PSIPRED in addss.pl)
...
#our $hhlib    = "/mnt/project/aquaria/HHblits_Psi-BLAST_compare/scripts/hhsuite-2.0.13";     # main hh-suite directory
